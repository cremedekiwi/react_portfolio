...
import SoLong from "../assets/project/so_long.jpg";
    ...
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${SoLong})` }}
            className="group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a
                  href="https://github.com/cremedekiwi/c_so_long"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a
                  href="https://github.com/cremedekiwi/c_pipex"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a
                  href="https://github.com/cremedekiwi/c_push_swap"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                {/* <a
                  href="https://cremedekiwi.github.io/css_reservia/"
                  target="_blank"
                  rel="noopener noreferrer"groupomania
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
                    Demo
                  </button>
                ...
                <a
                  href="https://github.com/cremedekiwi/c_get_next_line"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a
                  href="https://github.com/cremedekiwi/c_printf"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a
                  href="https://github.com/cremedekiwi/c_libft"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <button className="text-center rounder-lg px-4 py-3 m-2 bg-white text-primary font-bold text-lg">
