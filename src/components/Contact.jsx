    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/cc3c25e6-2c94-4260-a6a4-a0a9ae782a53" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'>Veuillez remplir le forumaire ci-dessous ou par email - jarumugam@outlook.fr </p>
            </div>
            <input className='bg-[#ccd6f6] p-2' type="text" placeholder='Nom' name="name" />
            <input className='my-4 p-2 bg-[#ccd6f6]' type="email" placeholder='Mail' name="email" />
